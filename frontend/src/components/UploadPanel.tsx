    ...
    return <section dir={direction} className="overflow-hidden rounded-2xl border border-[#dfe5e1] bg-white shadow-sm">
      <div className="grid min-h-[520px] lg:h-[calc(100vh-120px)] lg:max-h-[650px] lg:grid-cols-[240px_minmax(0,1fr)_280px]">
        ...
        <div className="flex flex-col justify-start px-5 py-5 text-center">
          ...
          <div className="relative mx-auto mt-3 aspect-[1.16/1] w-full max-w-[330px] overflow-hidden rounded-xl border border-[#dce7e2] bg-[#eff5f1]"><Image src="/branding/meyaar-processing-map.png" alt={arabic ? "خريطة شبكة الطرق الجاري فحصها" : "Road network map being analyzed"} fill sizes="330px" className="object-cover" priority/><div className="absolute inset-0 bg-gradient-to-t from-white/10 to-transparent"/></div>
