...
const translations: Record<string, string> = {
  ...
  "From data to a reliable decision": "من البيانات إلى قرار موثوق",
  "Upload your data": "ارفع بياناتك",
  "Choose geospatial files or map imagery.": "اختر ملفات البيانات المكانية أو صور الخرائط.",
  "We validate quality": "نفحص الجودة",
  "Meyaar applies quality, geometry, and topology rules.": "يطبق معيار قواعد الجودة والهندسة والطوبولوجيا.",
  "Review results": "راجع النتائج",
  "Inspect mapped issues and follow recommendations.": "استعرض الأخطاء على الخريطة واتبع التوصيات.",
  "About Meyaar": "عن معيار",
  "A Saudi platform for geospatial data quality": "منصة سعودية لجودة البيانات المكانية",
  "Meyaar helps data teams detect spatial errors, measure compliance, and understand results through interactive maps and AI-assisted recommendations.": "يساعد معيار فرق البيانات على اكتشاف الأخطاء المكانية، وقياس الالتزام، وفهم النتائج من خلال خرائط تفاعلية وتوصيات مدعومة بالذكاء الاصطناعي.",
  "Saudi geospatial standards": "المعايير الجغرافية السعودية",
  "Aligned rules": "قواعد متوافقة",
  "Artificial intelligence": "الذكاء الاصطناعي",
  "Clear guidance": "توصيات مفهومة",
  ...
  "Refresh chat": "تحديث المحادثة",
  "Clearing...": "جارٍ المسح...",
  "Answers are grounded in every file of this upload. Voice input and playback use your browser.": "تعتمد الإجابات على كل ملفات هذا الرفع، ويستخدم الإدخال والنطق الصوتي المتصفح.",
  "Ask about all files in this upload...": "اسأل عن كل الملفات في هذا الرفع...",
  "Send": "إرسال",
  ...
  "GeoSA-grounded": "مدعوم بمصادر GeoSA",
  "GeoRFP Assistant": "مساعد GeoRFP",
  "Describe the project and the geospatial section of the RFP will be generated using GeoSA sources.": "اكتب وصف المشروع وسيتم إنشاء الجزء الجيومكاني فقط من وثيقة طلب العروض بالاعتماد على مصادر GeoSA.",
  "Example: A project to update road and building data in Riyadh and deliver geospatial data according to quality requirements...": "مثال: مشروع لتحديث بيانات الطرق والمباني داخل مدينة الرياض وتسليم البيانات الجيومكانية وفق متطلبات الجودة...",
  "Generating...": "جارٍ الإنشاء...",
  "Generate GIS Requirements": "إنشاء المتطلبات الجيومكانية",
  "GIS Requirements": "المتطلبات الجيومكانية",
  "The result and its sources will appear here after generation.": "ستظهر النتيجة والمصادر هنا بعد إنشاء الوثيقة.",
  "Generated RFP": "طلب العروض المُنشأ",
  "Geospatial Technical Requirements": "المتطلبات الفنية الجيومكانية",
  "Copy": "نسخ",
  "The requirements could not be generated.": "تعذر إنشاء المتطلبات.",
  "GeoSA Sources": "مصادر GeoSA",
  "Page": "الصفحة",
  "POI Intelligence": "ذكاء نقاط الاهتمام",
  "Upload a POI dataset and let the agent select the appropriate analysis tools.": "ارفع بيانات نقاط الاهتمام ودع الوكيل يختار أدوات التحليل المناسبة.",
  "Analyze POI quality and identify important issues according to GeoSA.": "حلل جودة نقاط الاهتمام وحدد المشكلات المهمة وفق GeoSA.",
  "POI Dataset": "بيانات نقاط الاهتمام",
  "Analyzing...": "جارٍ التحليل...",
  "Analyze": "تحليل",
  "Total POIs": "إجمالي نقاط الاهتمام",
  "Affected": "المتأثرة",
  "Quality Score": "درجة الجودة",
  "Agent Tools": "أدوات الوكيل",
  "Agent tools": "أدوات الوكيل",
  "Missing names": "الأسماء المفقودة",
  "Missing categories": "التصنيفات المفقودة",
  "Invalid coordinates": "الإحداثيات غير الصالحة",
  "Duplicates": "التكرارات",
  "Category Distribution": "توزيع التصنيفات",
  "AI Interpretation": "تفسير الذكاء الاصطناعي",
  "Dataset Intelligence": "ذكاء مجموعات البيانات",
  "Dataset Compare": "مقارنة مجموعات البيانات",
  "Spatial comparison": "المقارنة المكانية",
  "Geometry differences": "اختلافات الهندسة",
  "AI Comparison": "مقارنة بالذكاء الاصطناعي",
  "AI interpretation unavailable.": "تفسير الذكاء الاصطناعي غير متاح.",
  "GeoJSON, GPKG or zipped Shapefile": "GeoJSON أو GPKG أو Shapefile مضغوط",
  "matched": "متطابقة",
  "Matched:": "المتطابقة:",
  "Only A:": "في أ فقط:",
  "Only B:": "في ب فقط:",
  "Compare two compatible geospatial datasets by structure, spatial content, and quality.": "قارن مجموعتي بيانات جيومكانية متوافقتين من حيث البنية والمحتوى المكاني والجودة.",
  "Dataset A": "مجموعة البيانات أ",
  "Dataset B": "مجموعة البيانات ب",
  "Comparing...": "جارٍ المقارنة...",
  "Compare": "مقارنة",
  "Compatibility": "التوافق",
  "Datasets are comparable": "مجموعتا البيانات قابلتان للمقارنة",
  "Datasets are not directly comparable": "مجموعتا البيانات غير قابلتين للمقارنة مباشرة",
  "Matched": "المتطابقة",
  "Spatial overlap": "التداخل المكاني",
  "Schema Comparison": "مقارنة البنية",
  "Spatial Match": "التطابق المكاني",
  "Quality Issues": "مشكلات الجودة",
  "Common": "المشتركة",
  "Only A": "في أ فقط",
  "Only B": "في ب فقط",
  "GeoSA Compliance": "التوافق مع GeoSA",
  "Features found in only one dataset or with different geometry are not automatically errors; they are differences that require interpretation based on each dataset's source and scope.": "العناصر الموجودة في مجموعة بيانات واحدة فقط أو ذات هندسة مختلفة لا تعد أخطاء تلقائيًا؛ بل اختلافات تحتاج إلى تفسير حسب مصدر ونطاق كل مجموعة.",
  "GeoSA Standards Assistant": "مساعد معايير GeoSA",
  "Ask about GeoSA standards or attach a file for analysis using official sources.": "اسأل عن معايير GeoSA أو أرفق ملفًا لتحليله بالاعتماد على المصادر الرسمية.",
  "How can I help?": "كيف أقدر أساعدك؟",
  "I can search GeoSA documents and connect the evidence to your file.": "أقدر أبحث في مستندات GeoSA وأربط الأدلة بملفك.",
  "What are the elements of geospatial data quality?": "ما هي عناصر جودة البيانات الجيومكانية؟",
  "What national spatial reference is used in Saudi Arabia?": "ما المرجع المكاني الوطني المستخدم في السعودية؟",
  "What are the quality requirements for road data?": "ما متطلبات جودة بيانات الطرق؟",
  "Sources": "المصادر",
  "Searching GeoSA sources...": "جارٍ البحث في مصادر GeoSA...",
  "Ask about GeoSA standards...": "اسأل عن معايير GeoSA...",
  "Answers are grounded in retrieved GeoSA documents. Review the source before making an official decision.": "الإجابات مبنية على مستندات GeoSA المسترجعة. راجع المصدر عند اتخاذ قرار رسمي.",
  "The request could not be completed.": "تعذر تنفيذ الطلب.",
  "Voice input is not supported by this browser.": "المتصفح لا يدعم الإدخال الصوتي.",
  "Meyaar AI Assistant": "مساعد معيار الذكي",
  "GeoSA Intelligence": "ذكاء GeoSA",
  "Ask grounded questions from official GeoSA standards.": "اطرح أسئلة تستند إلى معايير GeoSA الرسمية.",
  "Agentic analysis for points of interest and GeoSA evidence.": "تحليل ذكي لنقاط الاهتمام وأدلة GeoSA.",
  "Compare compatible geospatial datasets across structure, space and quality.": "قارن مجموعات البيانات الجيومكانية المتوافقة من حيث البنية والمكان والجودة.",
  "Generate GeoSA-grounded GIS requirements for RFPs.": "أنشئ متطلبات نظم معلومات جغرافية لطلبات العروض مستندة إلى GeoSA.",
