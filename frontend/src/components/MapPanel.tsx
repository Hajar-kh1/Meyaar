...
export default function MapPanel({
  ...
  const validation = isVectorResult(result)
    ? result.validation_after ?? result.validation
    : null;
        ...
        {isVectorResult(result) && (
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="rounded-full bg-blue-100 px-3.5 py-1.5 text-[11px] font-bold text-blue-800"
            >
              {t("Reset view")}
            </button>
          </div>
