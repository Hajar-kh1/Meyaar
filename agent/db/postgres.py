    ...
    def _ensure_agent_tables(self) -> None:
        statements = [
            ...
            CREATE TABLE IF NOT EXISTS public.agent_remediation_actions (
                remediation_id BIGSERIAL PRIMARY KEY, run_id UUID NOT NULL, result_id BIGINT NOT NULL,
                layer_name TEXT NOT NULL, feature_id TEXT, rule_id TEXT NOT NULL, action TEXT NOT NULL,
                remediation_type TEXT, status TEXT NOT NULL, issue TEXT NOT NULL DEFAULT '',
                reason TEXT NOT NULL DEFAULT '', recommended_action TEXT,
                before_state JSONB NOT NULL DEFAULT '{}'::jsonb, after_state JSONB NOT NULL DEFAULT '{}'::jsonb,
                agent_model TEXT, human_review_required BOOLEAN NOT NULL DEFAULT FALSE,
                executed_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
            )
            """,
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS remediation_id BIGSERIAL",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS run_id UUID",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS result_id BIGINT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS layer_name TEXT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS feature_id TEXT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS rule_id TEXT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS action TEXT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS remediation_type TEXT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS status TEXT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS issue TEXT NOT NULL DEFAULT ''",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS reason TEXT NOT NULL DEFAULT ''",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS recommended_action TEXT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS before_state JSONB NOT NULL DEFAULT '{}'::jsonb",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS after_state JSONB NOT NULL DEFAULT '{}'::jsonb",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS agent_model TEXT",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS human_review_required BOOLEAN NOT NULL DEFAULT FALSE",
            "ALTER TABLE public.agent_remediation_actions ADD COLUMN IF NOT EXISTS executed_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP",
            "CREATE UNIQUE INDEX IF NOT EXISTS uq_agent_remediation_run_result ON public.agent_remediation_actions (run_id, result_id)",
            "CREATE INDEX IF NOT EXISTS idx_agent_remediation_run ON public.agent_remediation_actions (run_id)",
            "CREATE INDEX IF NOT EXISTS idx_agent_remediation_status ON public.agent_remediation_actions (status, action)",
            """
            CREATE TABLE IF NOT EXISTS public.agent_run_summaries (
                run_id UUID PRIMARY KEY, narrative TEXT NOT NULL, agent_model TEXT,
                counts JSONB NOT NULL DEFAULT '{}'::jsonb,
                created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
            )
            """,
            "ALTER TABLE public.agent_run_summaries ADD COLUMN IF NOT EXISTS run_id UUID",
            "ALTER TABLE public.agent_run_summaries ADD COLUMN IF NOT EXISTS narrative TEXT",
            "ALTER TABLE public.agent_run_summaries ADD COLUMN IF NOT EXISTS agent_model TEXT",
            "ALTER TABLE public.agent_run_summaries ADD COLUMN IF NOT EXISTS counts JSONB NOT NULL DEFAULT '{}'::jsonb",
            "ALTER TABLE public.agent_run_summaries ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP",
            "CREATE UNIQUE INDEX IF NOT EXISTS uq_agent_run_summaries_run_id ON public.agent_run_summaries (run_id)",
            "CREATE INDEX IF NOT EXISTS idx_agent_run_summaries_created ON public.agent_run_summaries (created_at DESC)",
        ]
